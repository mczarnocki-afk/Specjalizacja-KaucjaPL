...
10. Place your input your bottle .png's in a raw_png folder
...
12. You will get `filename_processed.png` files in your processed_png folder, with transparent background.

13. If you want to convert them to .svg run

 ```
 python convert_to_svg.py
 ```

14. You will get `filename_detailed.svg` files in your processed_svg folder.

15. Any time you want to use MobileSAM, activate the environment:
 ```
 .\mobile_sam_env\Scripts\activate
